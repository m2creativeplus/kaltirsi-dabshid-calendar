...
export const KALTIRSI_MONTHS: HexTemporalMonth[] = [
  {
    ...
    name: "Karan",
    altNames: ["Habar-ari"],
    exactMeaningSomali: "Roob Dheeraad ah",
    detailedDescription: "Waa bil keenta roobab muhiim u ah in dalagga la goosto, gaar ahaan gobollada waqooyi-galbeed.",
  ...
  },
  {
    ...
    name: "Habar-ari",
    altNames: [],
    exactMeaningSomali: "Idaha iyo riyaha habartii",
    detailedDescription: "Waa magac yaraysi ah oo tilmaamaya in roobabkeedu yihiin kuwo goos-goos ah oo aan la isku halleyn karin, kuwaas oo inta badan keliya ku filan in ay daaqaan xoolaha yaryar ee adkaysiga leh.",
  ...
  },
  {
    ...
    exactMeaningSomali: "Diraac Dhab ah",
    detailedDescription: "Bishaani waxay matashaa waqtiga uu gaaro heerkulka ugu kulul uguna qallalan ee xilliga xagaaga, ka hor inta aan la gelin dayrta.",
  ...
  },
  {
    ...
    name: "Dayrweyn",
    altNames: ["Dambasame"],
    exactMeaningSomali: "Dayrtii weynayd",
    detailedDescription: "Waa bisha keenta roobabka ugu culus ee dayrta. Magaceeda kale ee Dambasame wuxuu tilmaamayaa habeenka rasmiga ah ee wanka lagu daro idaha si ay u dhalaan xilliga barwaaqada ee Gu'ga, 150 maalmood kadib.",
  ...
  },
  {
    ...
    name: "Ximir",
    altNames: ["Xoomir"],
    exactMeaningSomali: "Cas ama Guduud",
    detailedDescription: "Waxaa bishan si toos ah loogu magac daray xiddig cas oo xilligan bari ka soo baxa.",
  ...
  },
  {
    ...
    name: "Xays",
    altNames: [],
    exactMeaningSomali: "Xay (Ubax bixid ama dhalasho)",
    detailedDescription: "Waxaa lagu gartaa daruuro dhaqse u socda iyo roobab fudud oo xeebaha ka da'a, waxayna sidoo kale astaan u tahay Bad-furan oo ah waqtiga badda loo furi karo ganacsiga iyo safarrada doonyaha.",
  ...
  },
  {
    ...
    name: "Lixkor",
    altNames: ["Toddob"],
    exactMeaningSomali: "Lixdii oo la koray",
    detailedDescription: "Waa magac laga soo qaatay samada, kaas oo tilmaamaya dayaxa oo la dhaca xiddigaha Urur ama Laxaha (Pleiades) oo ka kooban lix xiddigood. Waa bilawga jiilaal adag oo xoolaha lagu celiyo ceelasha biyaha joogtada ah.",
  ...
  },
  {
    ...
    exactMeaningSomali: "Toddobadii",
    detailedDescription: "Si la mid ah Lixkor, bishan waxaa loogu magac daray koox xiddigo ah oo ka kooban toddoba xiddigood (a seven-star moon-constellation). Waa xilli dhaxameed rajo laga qabo roobab goos-goos ah.",
  ...
  },
  {
    ...
    exactMeaningSomali: "La aamini karin ama Waqti luntay",
    detailedDescription: "Waa digniin luuqadeed oo muujinaysa waqti xasaasi ah oo ay dhici karto in roobabkii hordhaca ahaa ee Gu'ga ay baaqdaan ama dib u dhacaan.",
  ...
  },
  {
    ...
    exactMeaningSomali: "Ceelkii looma baahna",
    detailedDescription: "Bixitaanka magacan wuxuu qeexayaa isbeddel nolosha xoolo-dhaqatada ah; maadaama roobabku ay hubaal yihiin, harooyinka iyo balliyada biyaha ayaa buuxsama, taas oo xoolaha ka nastiisa socdaalka dheer ee ceelasha oonka.",
  ...
  },
  {
    ...
    name: "Gu'soore",
    altNames: ["Cawl"],
    exactMeaningSomali: "Barkii Gu'ga",
    detailedDescription: "Waa waqtiga ugu barwaaqada iyo roobka badan sanadka. Magaceeda gobollada qaar ee Cawl wuxuu la xiriiraa in bishani si buuxda ula jaanqaaddo waqtiga cawsku baxo ee ay dhasho Cawsha (Soemmerring's gazelle).",
  ...
  },
  {
    id: 12,
    name: "Samuulad",
    altNames: ["Sagaal", "Dirir-Sagaalo"],
    exactMeaningSomali: "Barwaaqo",
    detailedDescription: "Bishaani waxay soo afmeertaa sannadka qorraxda, waana waqti muujinaya urursiga hantida xoolaha iyo dhammaadka roobabka Gu'ga, iyadoo dhinaca kalena digniin u ah Bad-xiran (waqtiga badda ay xirto dabayshu oo aan la safri karin).",
